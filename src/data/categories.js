    ...
    products: [
      {
        ...
        image: [
          { id: '0', path: '/images/iphone-13-pro-max-graphit.png', alt: 'iPad Air' },
          { id: '1', path: '/images/iphone-13-pro-front-back-graphit.png', alt: 'iPad Air' },
          { id: '2', path: '/images/iphone-13-pro-camera-graphit.png', alt: 'iPad Air' },
          { id: '3', path: '/images/ipad-air-collection.png', alt: 'iPad Air' },
        ],
      },
      {
        id: 1,
      ...
      },
      {
        ...
        image: [
          { id: '0', path: '/images/iphone-13-max-rose.png', alt: 'iPhone 13 pro' },
          { id: '1', path: '/images/iphone-13-front-back-rose.png', alt: 'iPhone 13 pro' },
          { id: '2', path: '/images/iphone-13-camera-rose.png', alt: 'iPhone 13 pro' },
          { id: '3', path: '/images/iphone-13-collection.png', alt: 'iPhone 13 pro' },
        ],
      },
      {
        id: 4,
        ...
        description:
          'The iPhone 13 offering advanced features and innovative technology. With its stunning Super Retina XDR display and A15 Bionic chip, the iPhone 13 delivers fast and responsive performance, making it perfect for gaming, streaming, and other demanding tasks. The device comes in four sizes, including a new 6.1-inch model, and features a Ceramic Shield front cover for increased durability. The iPhone 13 also features an advanced dual-camera system, including a 12MP ultra-wide lens and a 12MP wide lens, offering stunning photo and video capabilities. The device also includes new cinematic mode features, such as focus shifting and Dolby Vision HDR recording. The iPhone 13 comes with iOS 15, the latest version of Apple`s operating system, and supports 5G connectivity for fast internet access. With its long-lasting battery life, water-resistant design, and support for MagSafe accessories, the iPhone 13 is the ultimate smartphone for staying connected and productive.',
        image: [
          { id: '0', path: '/images/iphone-13-max-polarsilver.png', alt: 'iPhone 13 pro' },
          { id: '1', path: '/images/iphone-13-front-back-polarsilver.png', alt: 'iPhone 13 pro' },
          { id: '2', path: '/images/iphone-13-camera-polarsilver.png', alt: 'iPhone 13 pro' },
          { id: '3', path: '/images/iphone-13-collection.png', alt: 'iPhone 13 pro' },
        ],
      },
      {
        ...
        description:
          'The iPhone 13 offering advanced features and innovative technology. With its stunning Super Retina XDR display and A15 Bionic chip, the iPhone 13 delivers fast and responsive performance, making it perfect for gaming, streaming, and other demanding tasks. The device comes in four sizes, including a new 6.1-inch model, and features a Ceramic Shield front cover for increased durability. The iPhone 13 also features an advanced dual-camera system, including a 12MP ultra-wide lens and a 12MP wide lens, offering stunning photo and video capabilities. The device also includes new cinematic mode features, such as focus shifting and Dolby Vision HDR recording. The iPhone 13 comes with iOS 15, the latest version of Apple`s operating system, and supports 5G connectivity for fast internet access. With its long-lasting battery life, water-resistant design, and support for MagSafe accessories, the iPhone 13 is the ultimate smartphone for staying connected and productive.',
        image: [
          { id: '0', path: '/images/iphone-13-max-midnight.png', alt: 'iPhone 13 pro' },
          { id: '1', path: '/images/iphone-13-front-back-midnight.png', alt: 'iPhone 13 pro' },
          { id: '2', path: '/images/iphone-13-camera-midnight.png', alt: 'iPhone 13 pro' },
          { id: '3', path: '/images/iphone-13-collection.png', alt: 'iPhone 13 pro' },
        ],
      },
    ],
    ...
    products: [
      {
        ...
        image: [
          { id: '0', path: '/images/ipad-pro-front-back-silver.png', alt: 'iPad Pro' },
          { id: '1', path: '/images/ipad-pro-screen-silver.png', alt: 'iPad Pro' },
          { id: '2', path: '/images/ipad-pro-side-silver.png', alt: 'iPad Pro' },
          { id: '3', path: '/images/ipad-pro-portrait-silver.png', alt: 'iPad Pro' },
        ],
      },
      {
        id: 7,
        ...
        image: [
          {
            id: '0',
            path: '/images/ipad-pro-front-back-spacegray.png',
            alt: 'iPad Pro',
          },
          {
            id: '1',
          ...
          {
            id: '2',
            path: '/images/ipad-pro-screen-spacegray.png',
            alt: 'iPad Pro',
          },
          {
            id: '3',
            path: '/images/ipad-pro-portrait-spacegray.png',
            alt: 'iPad Pro',
          },
        ],
      },
      {
        ...
        image: [
          {
            id: '0',
            path: '/images/ipad-air-front-back-spacegray.png',
            alt: 'iPad Air',
          },
          {
            id: '1',
          ...
          {
            id: '2',
            path: '/images/ipad-air-camera-spacegray.png',
            alt: 'iPad Air',
          },
          {
            id: '3',
            path: '/images/ipad-air-side-spacegrey.png',
            alt: 'iPad Air',
          },
        ],
      },
      {
        ...
        image: [
          {
            id: '0',
            path: '/images/ipad-air-front-back-blue.png',
            alt: 'iPad Air',
          },
          {
            id: '1',
            path: '/images/ipad-air-front-blue.png',
            alt: 'iPad Air',
          },
          {
            id: '2',
            path: '/images/ipad-air-camera-blue.png',
            alt: 'iPad Air',
          },
          {
            id: '3',
            path: '/images/ipad-air-side-blue.png',
            alt: 'iPad Air',
          },
        ],
      },
