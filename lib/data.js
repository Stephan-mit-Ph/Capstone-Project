    ...
    products: [
      {
        ...
        color: "graphite",
        description:
          "The iPhone 13 Pro is the best iPhone ever. It has a 6.1-inch Super Retina XDR display, a 12MP triple camera system, and a 12MP TrueDepth front camera. It also has a 5G chip, a Ceramic Shield front cover, and a new A15 Bionic chip.",
          image: [
      ...
      },
      {
        ...
        color: "gold",
        description:
          "The iPhone 13 is the best iPhone ever. It has a 6.1-inch Super Retina XDR display, a 12MP triple camera system, and a 12MP TrueDepth front camera. It also has a 5G chip, a Ceramic Shield front cover, and a new A15 Bionic chip.",
          image: [
    ...
    products: [
      ...
      },
      {
        ...
        description:
          "The iPad Pro 2021 is Apple's latest and most advanced tablet yet, designed for professionals and power users. With a stunning Liquid Retina XDR display and the powerful M1 chip, the iPad Pro 2021 delivers unmatched performance for demanding tasks like video editing, 3D modeling, and gaming. The iPad Pro 2021 also features 5G cellular connectivity for faster internet speeds and supports the Apple Pencil (2nd generation) and Magic Keyboard (sold separately) for an effortless creative experience. With up to 10 hours of battery life and a range of storage options, the iPad Pro 2021 is the ultimate productivity tool for anyone who needs a powerful and portable device.",
        image: [
          "/images/ipad-pro-front-back-spacegrey.png",
          "/images/ipad-pro-screen-spacegrey.png",
          "/images/ipad-pro-side-spacegrey.png",
        ],
      },
      {
        id: 2,
    ...
    products: [
      {
        ...
        description:
          ...
          image: [
            "/images/airpods-pro-case.png",
            "/images/airpods-pro-top.png",
      ...
      },
      {
        ...
        image: [
          "/images/airpods-3-front.png",
          "/images/airpods-3-side.png",
          "/images/airpods-3-top.png",
          ],
      },
    ],
  },
